...
<template>
  <div class="page">
        ...
        <tbody>
          ...
          <template v-if="!loading && !error && tokens.length">
            <tr v-for="token in tokens" :key="token.id">
              ...
              <td><code class="chip">{{ token.masked_key }}</code></td>
              <td class="text-ink-200">{{ ownerText(token) }}</td>
    ...
    >
      <div class="space-y-5">
        <div>
          <label class="label" for="token-owner">归属用户 <span class="text-red-400">*</span></label>
          <select
            id="token-owner"
            v-model="ownerUserId"
    ...
    >
      <div class="space-y-5">
        ...
        <div class="grid gap-5 sm:grid-cols-2">
          <div>
            <label class="label" for="edit-token-name">名称 <span class="text-red-400">*</span></label>
